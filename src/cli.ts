...
const THIN_CLIENT_REFUSE_HINTS: Record<string, string> = {
  ...
  company: 'company ingestion/extraction/retrieval is local/manual for the trusted-workspace pilot. Run it on the host; hosted writes stay disabled in Stage 1.',
...
IMPORT/EXPORT
  ...
  company ingest meeting <file>      Stage 1C local/manual company transcript ingest
        [--doc PATH] [--no-embed]    Trusted workspace only; no live connectors
  company ingest doc <file>          Stage 1C local/manual linked-doc ingest
  company extract all|<slug>         Stage 1D local decisions/commitments/actions
